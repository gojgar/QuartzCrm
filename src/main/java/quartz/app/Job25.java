 ...
 */
public class Job25 implements org.quartz.Job{
                ...
                if(al.getAgent().equals("mihaela")) {
                  ...
                  sumaTotala = Double.parseDouble("250000");
                    ...
                    new SendMailQuartz("smtp.gmail.com", 587, "contact.inovo@gmail.com", "mjqvemprrmlinexr"
                      ...
                      "Buna " + Utils.formatAgent(al.getAgent()) + ",<br/><br/>Suntem aproape de finalul lunii, iar pana acum ai realizat " + Utils.formatValues(sumaLuna) + " RON " +
